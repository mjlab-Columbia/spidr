...
@command()
@option("--input", "-i", type=Path(exists=True), default=None, show_default=True, help="Path to barcoded read 1 gzipped, fastq file")
...
@option("--short_output", "-b", type=Path(), default=None, show_default=True, help="Output path for barcodes with incomplete reads")
